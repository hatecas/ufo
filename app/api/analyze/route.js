...
★ visual_guide を書くとき:
  ✗ "봉 기준 7cm 뒤" ← 어떤 봉인지 불명확！
  ✓ "뒤쪽 받침봉에서 바깥쪽으로 7cm" ← 명확
  ✓ "앞쪽 받침봉과 박스 앞면이 만나는 지점" ← 명확
...
例:
  "A1(22%,28%)〜A2(68%,72%)。앞쪽 받침봉 A3≈y58%。
   ...
   target_y = A2のy - 3% = 69%
   visual_guide: 좌우: 박스 중앙에서 약간 오른쪽, 앞뒤: 앞쪽 받침봉에서 바깥으로 약 6cm"
...

{
  ...
  "next_move": {
    ...
    "visual_guide": "좌우: [받침봉/박스 모서리 기준 상대 위치], 앞뒤: [앞쪽 받침봉 또는 뒤쪽 받침봉 기준 cm]",
