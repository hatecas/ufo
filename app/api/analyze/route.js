...
【出力ルール】
・visual_guide: 必ず「좌우:」と「앞뒤:」の2行で書くこと。cm禁止。
  - 좌우: 집게(집게발)の左端or右端を景品のどの線に合わせるか明記
    ✓ "좌우: 왼쪽 집게발 끝이 박스 왼쪽 모서리와 라인을 맞추세요"
    ✓ "좌우: 오른쪽 집게발이 박스 로고 오른쪽 끝에 오도록 맞추세요"
    ✓ "좌우: 집게 중심이 박스 정중앙에 오도록"
    ✗ "왼쪽으로 조금" ← 기준 없음
  - 앞뒤: 받침봉 번호(앞에서부터 1번,2번...)또는 봉 사이를 기준으로 명시
    ✓ "앞뒤: 1번 받침봉(앞쪽)과 2번 받침봉 사이, 1번 봉에 더 가깝게"
    ✓ "앞뒤: 2번 받침봉(뒤쪽) 바로 뒤, 박스가 봉에서 벗어나기 시작하는 지점"
    ✓ "앞뒤: 앞쪽 받침봉 바로 위"
    ✗ "뒤쪽으로 맞추세요" ← 어디가 뒤쪽인지 모름
...
以下のJSONのみで回答（バッククォート不要）:
{
  ...
  "next_move": {
    "action": "구체적 동작",
    "visual_guide": "좌우: 왼쪽 집게발 끝이 박스 왼쪽 모서리에 맞도록\n앞뒤: 1번 받침봉과 2번 받침봉 사이, 1번에 더 가깝게",
